...
from .models import STGClassificationModel, STGRegressionModel, MLPClassificationModel,L1ClassificationModel ,MLPRegressionModel, STGCoxModel, MLPCoxModel, L1RegressionModel, SoftThreshRegressionModel, L1GateRegressionModel
...
class STG(object):
    ...
    def fit(self, X, y, nr_epochs, valid_X=None, valid_y=None, 
        ...
        gates_mu,gates_prob=self.train(data_loader, nr_epochs, val_data_loader, verbose, meters, early_stop, print_interval)
        return  gates_mu,gates_prob
    ...
    def train(self, data_loader, nr_epochs, val_data_loader=None, verbose=True, 
        ...
        for epoch in range(1, 1 + nr_epochs):
            ...
            gates_mu.append(np.copy(self.get_gates(mode='raw')))
            gates_prob.append(np.copy(self.get_gates(mode='prob')))
